<template>
  <div class="member-point-log">
    ...
    <el-table :data="pointLogList">
      ...
      <el-table-column prop="point" label="数量" sortable>
        <template slot-scope="scope">
...
import { getMemberPointList } from '@/api/member'
...
export default {
  ...
  methods: {
    refresh () {
      ...
      getMemberPointList(params)
        .then(res => {
          console.log(res)
          if (res.data.status) {
            this.pointLogList = res.data.data.UserList
