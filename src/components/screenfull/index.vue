<template>
  <svg t="1508738709248" @click='click' class="screenfull-svg" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2069" xmlns:xlink="http://www.w3.org/1999/xlink" :width="width" :height="height">
  ...
  methods: {
    click () {
      if (!screenfull.enabled) {
        this.$message({
          message: '您的浏览器不支持全屏显示，建议使用谷歌浏览器',
          type: 'warning'
        })
        return false
      }
